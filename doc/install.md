...
If you prefer an ```Integrated Programming Environment (IDE)``` which  keeps track of your project, you could try the [Atom Editor](https://atom.io) (among many other good choices).
